...
const ContactForm = () => {
    ...
    const postForm = (e) => {
        ...
        $api
            .post('http://test.insource.uz/forms/d9618010abdc4f8f9e7396da399566eb', item)
            .then(res => {
                console.log(res)
            })
    }
        ...
        <div className='contact-form' id='contact'>
            <div className="container small">
                <div className="contact-form__inner">
                    ...
                    <iframe className='form form2' src="http://test.insource.uz/forms/d9618010abdc4f8f9e7396da399566eb"/>
                    <div>
                        ...
                        {/*    </label>*/}
                        {/*    <label>*/}
                        {/*        <span className='txt'>Description <span>*</span></span>*/}
                        {/*        <textarea*/}
                        {/*            className='inp area'*/}
                        {/*            required={true}*/}
