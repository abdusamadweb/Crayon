            ...
            <div className="container small">
                <div className="baseline__inner">
                    <div>
                        ...
                        <p className="desc">
                            Crayon is an Adobe Premium Reseller, with extensive knowledge in both Creative Cloud, Acrobat DC and Adobe for the Education sector.
                        </p>
                        <p className="desc">The key benefits of buying Adobe from Crayon are:  </p>
                        <ul className="list">
                            <li className="desc dot">Software that’s always up to date </li>
                            <li className="desc dot">A dedicated contact person at Crayon and fast support when you need it </li>
                    ...
                    <div className="padding">
                        ...
                        <p className="desc">
                            When you buy Adobe Creative Cloud through Crayon you get a dedicated contact person. Our local experienced consultants are always ready to lend a helping hand.
                        </p>
                        <p className="desc">
