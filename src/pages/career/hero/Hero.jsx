            ...
            <div className="container">
                <div className="hero__inner">
                    <div className="hero__titles">
                        ...
                        <h1 className="title">Life at Crayon</h1>
                    </div>
                    <div className="hero__descs">
                        ...
                        <p className='desc'>
                            A career at Crayon not only gives you the tools to tackle tomorrow’s technology – it connects you to a unique community.
                        </p>
