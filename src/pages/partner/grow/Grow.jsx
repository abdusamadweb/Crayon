        ...
        <div className='grow'>
            <div className="container small">
                <div className="grow__inner">
                    <h3 className="title">Crayon Partner Benefits</h3>
                    <div className='grid'>
                        <div>
                            <div className='margin'>
                                <span className="sub">GROW YOUR SOFTWARE AND CLOUD BUSINESS</span>
                                <p className='desc'>
                                    Now you can leverage Crayon expertise to have licensing <strong>optimization conversations with your customers.</strong>
                                </p>
                                <p className='desc'>
                                    We help our partners have more control over their software estate to optimize ROI while remaining compliant through our Software Analytics and Cloud Analytics practice. As a Crayon partner, you will be able to bundle our professional services and partner together to enhance your offerings to your end customers. When engaging Crayon, customers save an average of 20-30% on their software and cloud spend.​
                                </p>
                            </div>
                            <div>
                                <span className="sub">TRANSACT MICROSOFT CSP AND SPLA</span>
                                <p className='desc'>
                                    As the third-largest SPLA reseller​ and CSP indirect provider globally, Crayon is positioned to help you make your reporting and consumption easy. You can own the customer relationship, and we will support you. Click here to learn specifically about <Link className='link' to='/services/operate-support'>Crayon CSP Partner benefits.</Link>
                                </p>
                            </div>
                        </div>
                        <div>
                            <div>
                                <span className="sub">GAIN ACCESS TO DEEPER ANALYTICS THAN OUR COMPETITORS WITH CRAYON IP</span>
                                <p className="desc dot">
                                    <Link className='link' to=''>Crayon Cloud-iQ</Link> is a self-service platform where you can manage Cloud products, services, and economics across multiple vendors through a single pane portal view. Cloud-iQ provides instant access to cloud services, comprehensive live spending reports, and flexibility to adjust services and costs as you go.
                                </p>
                                <p className="desc dot">
                            ...
                            <div>
                                <span className="sub">
                                    PARTNERS CAN ALSO BENEFIT FROM THESE AREAS WHERE CRAYON HAS DEEP EXPERTISE:
                                </span>
                                <p className="desc dot">
                                    Datacenter optimization: Crayon will help develop cloud strategies and drive incremental revenue for your business.
                                </p>
                                <div className="desc dot">App modernization</div>
                                <div className="desc dot">Support: Crayon offers best-in-class support for both on-premises and off-premises. We are here to complement or fully support your end customer support model.​</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <div className='margin'>
                                ...
                                <p className="desc">
                                    ...
                                    Reduce costs by minimizing time spent on cloud and software purchases. Our partners benefit from Crayon’s own platforms to handle software and cloud-related purchases.
                                </p>
                                <p className='desc'>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p className="desc">
                                    ...
                                    Crayon offers a license and technical support program to our partners, basic to premium plans covering all your needs. Our partners have access to the highest level of vendor support, with the best SLAs.
                                </p>
                            </div>
                        </div>
                    </div>
