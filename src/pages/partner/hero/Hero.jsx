            ...
            <div className="container small">
                <div className="hero__inner">
                    <div className="hero__titles">
                        <span className="sub">CRAYON CHANNEL BUSINESS</span>
                        <h1 className="title">The IT Partners' Partner</h1>
                    </div>
                    <div className="hero__descs">
                        <p className="desc">
                            For hosters, MSPs, ISVs, system integrators or Dynamics partners; our channel business is a Crayon entity that helps IT providers get the most profitable CSP and SPLA business.
                        </p>
                        <p className="desc">
